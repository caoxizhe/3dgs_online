#
nohup bash Run_all.sh > run_jitan.log 2>&1 &

# 选择图片并降采样到最大边800像素
rm ./data/lidazhao/* -rf
cp /data0/sumai/data/lidazhao/lidazhao/images ./data/lidazhao/ -r
python random_select_images.py data/lidazhao/images 100 deleted 1000 # 21s
bash ./colmap.sh  #10:31:18-10:31:32 75s
mkdir -p ./data/lidazhao/dense/sparse/0
mv data/lidazhao/dense/sparse/* data/lidazhao/dense/sparse/0
python msv2/train.py -s ./data/lidazhao/dense/ -m outputs/lidazhao_5 --eval --imp_metric outdoor --config_path ./config/fast   # 112.103260s
